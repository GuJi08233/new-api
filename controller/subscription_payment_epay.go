...
func SubscriptionEpayNotify(c *gin.Context) {
	...
	if err := model.CompleteSubscriptionOrder(model.ClientLogSource(c), verifyInfo.ServiceTradeNo, common.GetJsonString(verifyInfo), model.PaymentProviderEpay, verifyInfo.Type); err != nil {
		_, _ = c.Writer.Write([]byte("fail"))
		return
	}
